...
const Tweet = ({tweet,user}) => {
    ...
    const [comment,setComment] = useState(tweet.comments.length)
                    ...
                    <div className='flex flex-col w-full  pt-2'>
                        ...
                        <div className='flex py-2 gap-8'>
                            <span className='flex hover:text-blue-400 cursor-pointer'>
                                ...
                                </svg>{tweet.comments ? tweet.comments.length : "11" } 
                            </span>
                            <span className='flex hover:text-green-400 cursor-pointer'>
                                <svg onClick={e => handleRetweet(e)} viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 mr-2">
                                    <g>
                            ...
                            <span className='flex hover:text-red-500 cursor-pointer'>
                                <svg onClick={e => handleLike(e)} viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 mr-2">
                                    <g>
