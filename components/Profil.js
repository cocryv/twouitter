...
const Profil = ({user,target}) => {
    ...
    return (
        <div className='relative'>
            <div className='w-full h-48 bg-slate-400 cursor-pointer'>
