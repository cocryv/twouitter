...
const register = () => {
    ...
    return (
        <div className=" bg-slate-800 min-h-screen flex items-center">
            ...
            <span className="font-medium">You have been successfully registered !</span> <span className='font-bold hover:underline cursor-pointer' onClick={()=>{router.push("/login")}}>Click here to connect.</span>
            </div>
