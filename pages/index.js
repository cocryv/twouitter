    ...
    <div className="bg-twitter-dark text-white">
      ...
      <div className="container mx-auto min-h-screen">
        <div className='flex flex-row justify-center'>
          <div className='w-68 xs:w-88 xl:w-275 sticky h-screen border border-black'>
            <div className='flex flex-col h-screen xl:pr-3 fixed overflow-y-auto w-68 xs:w-88 xl:w-275'>
              <h1 className='h-14'>
                <a href="">
                <svg viewBox="0 0 24 24" class="w-8 h-8 text-blue-400 dark:text-white" fill="#FFFF">
                  <g>
              ...
              <nav className='flex flex-col gap-2'>
                <a className='flex gap-2 justify-center xl:justify-start' href="">
                  ...
                  <span className='hidden xl:block ml-4 font-bold text-md mb-8'>Accueil</span>
                </a>
                <a className='flex gap-2 justify-center xl:justify-start' href="">
                  <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
                  ...
                  <span className='hidden xl:block ml-4 font-bold text-md mb-8'>Explorer</span>
                </a>
                <a className='flex gap-2 justify-center xl:justify-start' href="">
                  <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
                  ...
                  <span className='hidden xl:block ml-4 font-bold text-md mb-8'>Notification</span>
                </a>
                <a className='flex gap-2 justify-center xl:justify-start' href="">
                  <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
                  ...
                  <span className='hidden xl:block ml-4 font-bold text-md mb-8'>Message</span>
                </a>
                <a className='flex gap-2 justify-center xl:justify-start mb-8' href="">
                  <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
          ...
          <div className='w-full sm:w-600 min-h-screen border border-black'>
            <div className="flex justify-center items-center h-14 border border-black">
